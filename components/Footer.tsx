    ...
    <footer className="py-12 px-4 bg-gradient-to-b from-white to-sky-50">
      ...
      >
        <div className="glass-effect rounded-2xl p-8 mb-8">
          ...
          <p className="font-homemade text-xl text-gray-600 mb-6">
        ...
        <div className="text-center">
          ...
          <p className="font-homemade text-lg text-gray-600">
            #JosephAyuWedding
          </p>
          <p className="font-homemade text-sm text-gray-500 mt-4">
