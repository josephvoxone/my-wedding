            ...
            <div className="space-y-4">
              ...
              <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
                <iframe 
                  ...
                  src="https://www.youtube.com/embed/EjFCDuE9sKE?si=hVllXjaKg8MiB15H" 
                  title="Joseph & Ayu Wedding Live Stream" 
                  frameBorder="0" 
              ...
              <a
                ...
                className="w-full bg-white hover:bg-cream border-2 border-red-500 text-red-500 font-libre py-3 px-6 rounded-full transition-colors duration-300 flex items-center justify-center gap-2"
              >
