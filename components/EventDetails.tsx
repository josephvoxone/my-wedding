...
export default function EventDetails() {
  ...
  return (
    <section ref={containerRef} id="event-details" className="py-20 px-4 bg-gradient-to-b from-white to-sky-50 overflow-hidden relative">
      <div className="max-w-6xl mx-auto">
          ...
          {events.map((event, index) => (
            ...
            >
              ...
              <div className="space-y-2 mb-6">
                <p className="font-gaegu text-xl text-gray-700">{event.date}</p>
                <p className="font-gaegu text-2xl text-gray-800 font-bold">{event.time}</p>
              </div>
              <div className="border-t border-gray-200 pt-4">
                <p className="font-gaegu text-xl text-gray-700 mb-1 font-bold">{event.venue}</p>
                <p className="font-gaegu text-gray-600 text-sm">{event.address}</p>
              </div>
            </motion.div>
          ))}
        </div>
        ...
        >
          <div className="glass-effect rounded-2xl p-6 inline-block">
            <p className="font-gaegu text-xl text-gray-700 mb-2">Dress Code</p>
            <p className="font-gaegu text-2xl text-gray-800 font-bold">Batik & Formal</p>
