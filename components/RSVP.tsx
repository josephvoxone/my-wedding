      ...
      <section id="rsvp" className="py-20 px-4 bg-gradient-to-b from-sky-50 to-white">
        <div className="max-w-2xl mx-auto text-center">
          ...
          >
            ...
            <p className="font-gaegu text-xl text-gray-600">
        ...
        >
          <motion.div className="space-y-6">
            <motion.div variants={itemVariants}>
              <label className="block font-gaegu text-xl text-gray-700 mb-2">
                Nama Kamu
              </label>
              <input
                type="text"
                ...
                className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-blue-300 focus:outline-none transition-colors font-gaegu"
            ...
            <motion.div variants={itemVariants}>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={4}
                className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-blue-300 focus:outline-none transition-colors resize-none font-gaegu"
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              type="submit"
              className="w-full bg-gradient-to-r from-blue-100 to-purple-100 hover:from-blue-200 hover:to-purple-200 text-gray-800 font-gaegu text-xl py-4 rounded-lg transition-all duration-300"
            >
              Kirim Konfirmasi
            </motion.button>
          </motion.div>
