...
DROP TABLE IF EXISTS spiritual_votes;
...
-- Wishes/RSVP table (NO FOREIGN KEY)
CREATE TABLE IF NOT EXISTS wishes (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  guest_slug TEXT,
  guest_name TEXT NOT NULL,
  message TEXT NOT NULL,
  attendance_status TEXT CHECK(attendance_status IN ('hadir', 'tidak_hadir', 'streaming')),
  created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
  is_approved INTEGER DEFAULT 1
);

-- Spiritual journey voting table (NO FOREIGN KEY)
